...
@store1.employees.create(first_name: "Jim", last_name: "Bean", hourly_rate: 10)
@store2.employees.create(first_name: "Lord", last_name: "Voldemort", hourly_rate: 9000)
@store2.employees.create(first_name: "Bilbo", last_name: "Baggins", hourly_rate: 1)